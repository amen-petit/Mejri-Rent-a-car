...
5. `CarDetailPage()` - 19 edges
6. `isAdminRequest()` - 19 edges
...
Cohesion: 0.20
Nodes (10): dependencies, next, nodemailer, react, react-dom, server-only, @supabase/supabase-js, @upstash/ratelimit (+2 more)
