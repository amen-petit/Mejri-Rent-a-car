# Graph Report - Mejri-Rent-a-car  (2026-07-18)

## Corpus Check
- 255 files · ~353,596 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4860 nodes · 7661 edges · 333 communities (308 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 155 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `97d6a7d6`
...
1. `getSupabaseAdmin()` - 31 edges
2. `useI18n()` - 30 edges
3. `isAdminRequest()` - 25 edges
4. `readLiveServerInfo()` - 22 edges
5. `Impeccable Skill (SKILL.md)` - 20 edges
6. `CarDetailPage()` - 19 edges
7. `compilerOptions` - 17 edges
8. `CarDetailPageContent()` - 17 edges
9. `Royal Car - App Documentation` - 17 edges
10. `handleClick()` - 17 edges
...
- `Typography Reference (agents mirror)` --semantically_similar_to--> `Impeccable Skill (SKILL.md)`  [INFERRED] [semantically similar]
  .agents/skills/impeccable/reference/typography.md → .claude/skills/impeccable/SKILL.md

## Import Cycles
- None detected.

## Hyperedges (group relationships)
- **Impeccable Live Mode Subsystem** — impeccable_live_server, impeccable_live_session_store, impeccable_live_poll, impeccable_live_accept, impeccable_live_complete, impeccable_live_resume, impeccable_live_status, impeccable_live_completion, impeccable_live_inject, impeccable_paths [INFERRED 0.95]
- **Impeccable Skill Package** — skills_lock, impeccable_cleanup_deprecated, impeccable_command_metadata, impeccable_critique_storage, impeccable_design_parser, impeccable_detect_csp, impeccable_detect, impeccable_paths, impeccable_is_generated [EXTRACTED 1.00]
- **Project Build Configuration** — package_json, eslint_config, postcss_config, tsconfig [EXTRACTED 1.00]
- **Accessibility Resilience Triad** — harden_accessibility_resilience, motion_reduced_motion, interaction_focus_rings [INFERRED 0.85]
...
## Communities (333 total, 25 thin omitted)
...
Cohesion: 0.10
Nodes (37): Params, GET(), POST(), bustPromoCaches(), DELETE(), EXT_BY_MIME, Params, POST() (+29 more)
...
Cohesion: 0.07
Nodes (60): hasGeneratedHeader(), HEADER_MARKERS, isGeneratedFile(), isGitIgnored(), argVal(), buildCssAuthoring(), buildCssSelectorPrefixExamples(), buildSearchQueries() (+52 more)
...
Cohesion: 0.08
Nodes (35): buildCollapsible(), buildColorModels(), buildDesignHeader(), buildRadiiModels(), buildTypographyModels(), escapeHtml(), fetchDesignSystem(), fontStack() (+27 more)

### Community 6 - "Community 6"
Cohesion: 0.13
Nodes (27): cli(), DESIGN_NAMES, FALLBACK_DIRS, firstExisting(), LEGACY_NAMES, loadContext(), PRODUCT_NAMES, resolveContextDir() (+19 more)
...
Cohesion: 0.06
Nodes (94): buildColor(), CANONICAL_SECTIONS, collectBullets(), collectColorValues(), collectParagraphs(), detectFormat(), extractColors(), extractComponents() (+86 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (27): Live CLI Entry Point (agents), Load Context (agents), configurations, version, hooks, PreToolUse, Critique Storage, Design Parser (DESIGN.md) (+19 more)
...
Cohesion: 0.04
Nodes (41): engagements, features, Home(), metadata, steps, testimonials, sitemap(), LocationSection() (+33 more)
...
Cohesion: 0.08
Nodes (45): Error(), BookingSearchCard(), Hero(), Props, useI18n(), formatDate(), interpolate(), monthName() (+37 more)
...
Cohesion: 0.11
Nodes (33): GET(), ADDON_KEYS, ADDON_SERVICES, AddonKey, AddonLine, AddonService, computeAddonLines(), getAddonService() (+25 more)
...
Cohesion: 0.09
Nodes (54): acceptCli(), argVal(), deindentContent(), detectCommentSyntax(), expandReplaceRange(), EXTENSIONS, extractCss(), extractInnerByAttr() (+46 more)
...
Cohesion: 0.17
Nodes (13): Celebration Moments, Edge Cases & Boundary Conditions, Aha Moment Onboarding, Empty State Design, Progressive Onboarding Disclosure, Onboarding Reference, First-Timer Persona (Jordan), Stress Tester Persona (Riley) (+5 more)

### Community 57 - "Community 57"
Cohesion: 0.19
Nodes (13): Micro-interactions & Animation, Motion Design Reference, 100/300/500 Duration Rule, Easing Curve Selection, Perceived Performance through Motion, Staggered Animations, Core Web Vitals Optimization, Image Optimization Strategy (+5 more)

### Community 58 - "Community 58"
Cohesion: 0.19
Nodes (13): CSS Anchor Positioning, Interaction Design Reference, Eight Interactive States, Focus Ring Design, Popover API, Roving Tabindex Pattern, Persona: Alex (Power User), Persona: Casey (Distracted Mobile) (+5 more)
...
Cohesion: 0.08
Nodes (30): cairo, dmSans, fraunces, inter, metadata, RootLayout(), spaceGrotesk, websiteSchema (+22 more)
...
Cohesion: 0.10
Nodes (28): __dirname, findHarnessDirs(), generatePinnedSkill(), HARNESS_DIRS, loadCommandMetadata(), pin(), root, unpin() (+20 more)

### Community 65 - "Community 65"
Cohesion: 0.17
Nodes (12): Product Color Conventions, Product Color Rules, Product Motion Rules, Product Register Reference, Product Register (App UI Design Mode), Product Slop Test, Product Typography Rules, Color Refinement for Quieter Design (+4 more)
...
Cohesion: 0.18
Nodes (11): dependencies, next, nodemailer, react, react-dom, server-only, @supabase/supabase-js, @upstash/ratelimit (+3 more)
...
Cohesion: 0.20
Nodes (9): Anti-Patterns Verdict, Critique: Hero (`src/components/Hero.tsx`) — brand register, Design Health Score, Minor Observations, Overall Impression, Persona Red Flags, Priority Issues, Questions to Consider (+1 more)

### Community 74 - "Community 74"
Cohesion: 0.20
Nodes (10): CI Build Step, CI Lint Step, CI Security Audit Step, CI Typecheck Step, CI Unit Tests Step, CI Supabase Dummy Env Vars, CI Pull Request Trigger, CI Push Trigger (main/master) (+2 more)

### Community 75 - "Community 75"
Cohesion: 0.29
Nodes (10): Royal Car Brand Logo (Dark BG), Address/Location Pin Icon, Car/Vehicle Icon, Location/Shopping Cart Icon, Phone/Signal Icon, Star/Rating Icon, Telephone/Call Icon, Muscle Car/Sports Car Icon (+2 more)

### Community 76 - "Community 76"
Cohesion: 0.29
Nodes (10): Critique Storage, Is Generated File, Live Accept/Discard, Live Complete CLI, Live Completion Helpers, Live Poll CLI, Live Resume CLI, Live Session Store (+2 more)

### Community 77 - "Community 77"
Cohesion: 0.33
Nodes (9): Anti-references, Critical constraints, Open questions (for follow-up), Overview, Primary goals, Register, Strategic principles, Tone & Brand (+1 more)

### Community 78 - "Community 78"
Cohesion: 0.27
Nodes (10): Delight Principles, Information Architecture Simplification, Accessibility Resilience, Reduced Motion Accessibility, Progressive Enhancement in Overdrive, Accessibility-Dependent User Persona (Sam), Polish Checklist, Design System Alignment in Polish (+2 more)

### Community 79 - "Community 79"
Cohesion: 0.20
Nodes (10): Fluid Typography via clamp(), Font Loading Strategy (swap/optional), OpenType Feature Usage, Typography Reference, Vertical Rhythm Principle, UI/UX Design System Command, UI/UX Pro Max Prompt, UI/UX Pro Max Skill (+2 more)
...
Cohesion: 0.36
Nodes (8): Accessibility, Components (prioritized), Design tokens & system, Developer handoff, Implementation notes, Motion, Spacing & layout, Typography

### Community 83 - "Community 83"
Cohesion: 0.25
Nodes (9): Content Simplification, Error Handling & Recovery, Aesthetic and Minimalist Design Heuristic, Error Prevention Heuristic, Nielsen's 10 Usability Heuristics, Issue Severity Scoring (P0-P3), Visibility of System Status Heuristic, Undo Over Confirmation Pattern (+1 more)
...
Cohesion: 0.29
Nodes (8): Carbonize Accept Cleanup, Live Mode Contract, Live Poll Loop Contract, Live Mode Reference, Live Variant Parameters Contract, Typography Hierarchy Assessment, Typeset Reference, Typeset Scale Live Param

### Community 89 - "Community 89"
Cohesion: 0.25
Nodes (8): Live Generate Event Handler, Animation Performance Optimization, Rendering Performance Optimization, Overdrive Reference, Overdrive Browser Toolkit, View Transitions API, Virtual Scrolling for Large Datasets, WebGL & WebGPU Rendering
...
Cohesion: 0.06
Nodes (34): computedHash, skillPath, source, sourceType, computedHash, skillPath, source, sourceType (+26 more)

### Community 92 - "Community 92"
Cohesion: 0.29
Nodes (8): pg_advisory_xact_lock (overbooking prevention), cars (Supabase table), create_reservation_if_available (Postgres function), pickup_time / return_time columns migration, reservations (Supabase table), RLS Policy: cars_public_select, RLS: reservations fully locked, Storage: remove public upload policy
...
Cohesion: 0.29
Nodes (6): ESLint Config, name, private, version, PostCSS Config, TypeScript Config
...
Cohesion: 0.40
Nodes (6): Impeccable Command Metadata, Design Parser (DESIGN.md), Detect Anti-patterns CLI, Detect CSP, Live Inject Script Tag, Live Server

### Community 97 - "Community 97"
Cohesion: 0.18
Nodes (10): 1. Brand name & contact (environment variables), 2. Color palette (one CSS block), 3. Other per-client configuration (env), Quick rebrand checklist, Reselling this template — per-client setup, 1. Brand name & contact (environment variables), 2. Color palette (one CSS block), 3. Other per-client configuration (env) (+2 more)

### Community 98 - "Community 98"
Cohesion: 0.40
Nodes (5): File/Document Icon, Globe/Web Icon, Next.js Framework Logo, Vercel Platform Logo, Window/Browser Icon

### Community 99 - "Community 99"
Cohesion: 0.40
Nodes (5): Visual Hierarchy through Space, Live Mode Identity Extraction, Live Mode Parameter System, Live Mode Variant Generation, Typeset Live Mode Scale Param

### Community 100 - "Community 100"
Cohesion: 0.22
Nodes (9): candidates, detectorPath, __dirname, candidates, detectorPath, __dirname, candidates, detectorPath (+1 more)

### Community 101 - "Community 101"
Cohesion: 0.50
Nodes (4): Variant Scaffold Pattern (live iteration), Style Mode Detection (scoped vs astro-global-prefixed), Variant Scaffold (impeccable-variants wrapper), wrapCli (Element Wrapper CLI)

### Community 102 - "Community 102"
Cohesion: 0.14
Nodes (14): Admin, Database setup (Supabase), Deployment (Vercel), Environment variables, Features, Getting started, Mejri Rent a Car, Prerequisites (+6 more)
...
Cohesion: 0.22
Nodes (8): csp, nextConfig, securityHeaders, supabaseHostname, csp, nextConfig, securityHeaders, supabaseHostname
...
Cohesion: 0.07
Nodes (30): ConfirmOptions, ConfirmState, FeedbackContext, FeedbackContextValue, FeedbackProvider(), ToastItem, ToastVariant, useConfirm() (+22 more)

### Community 154 - "Community 154"
Cohesion: 0.10
Nodes (18): Aggressive Escalation Triggers, Guidelines, Operating Posture, Part 1 — Findings table (REQUIRED), Part 2 — Verdict (REQUIRED), Remedial Preference Hierarchy, Required Output Format, Reviewing Animations (+10 more)
...
Cohesion: 0.09
Nodes (30): applyEvent(), baseSnapshot(), COMPLETED_PHASES, getJournalPath(), getSnapshotPath(), rebuildSnapshotFromJournal(), safeSessionId(), toPendingEvent() (+22 more)
...
Cohesion: 0.10
Nodes (17): Footer(), FooterNavItem, legalItems, navItems, isSamePageHashClick(), performHashScroll(), scrollToHashOnSamePage(), NAV_LINKS (+9 more)
...
Cohesion: 0.12
Nodes (32): kebab(), listSnapshotsForSlug(), main(), nowFilenameStamp(), parseFrontmatter(), readLatestSnapshot(), readTrend(), serializeFrontmatter() (+24 more)
...
Cohesion: 0.08
Nodes (24): navItems, CAR_CATEGORIES, DAYS_FR, DEFAULT_PROMO_BADGE_STYLE, FUEL_TYPES, MONTHS_FR_SHORT, PROMO_BADGE_STYLES, PROMOTION_TYPES (+16 more)

### Community 176 - "Community 176"
Cohesion: 0.27
Nodes (12): completeCli(), completeThroughServer(), parseArgs(), readServerInfo(), completeCli(), completeThroughServer(), parseArgs(), readServerInfo() (+4 more)
...
Cohesion: 0.07
Nodes (46): appendOriginToDirective(), buildTagBlock(), commentClose(), commentOpen(), CONFIG_PATH, __dirname, findCspMetaTags(), getAttr() (+38 more)
...
Cohesion: 0.17
Nodes (15): buildPollReplyPayload(), pollCli(), postReply(), readServerInfo(), buildPollReplyPayload(), pollCli(), postReply(), readServerInfo() (+7 more)
...
Cohesion: 0.07
Nodes (41): AdminSessionPayload, constantTimeEqual(), createAdminSessionToken(), fromBase64Url(), importSecretKey(), signValue(), toBase64Url(), verifyAdminSessionToken() (+33 more)
...
Cohesion: 0.17
Nodes (16): parseArgs(), resumeCli(), fetchServerStatus(), readServerInfo(), statusCli(), parseArgs(), resumeCli(), fetchServerStatus() (+8 more)
...
## Knowledge Gaps
- **2217 isolated node(s):** `eslintConfig`, `config`, `supabaseHostname`, `csp`, `securityHeaders` (+2212 more)
...
- **What is the exact relationship between `Sitemap Generator` and `Environment-Variable Configuration`?**
  _Edge tagged AMBIGUOUS (relation: references) - confidence is low._
- **Why does `readLiveServerInfo()` connect `Community 186` to `Community 0`, `Community 263`, `Community 174`, `Community 176`, `Community 182`?**
...
- **Why does `Design Brief Output` connect `Community 47` to `Community 57`, `Community 58`, `Community 36`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._