...
export const fr = {
  ...
  booking: {
    ...
    locations: {
      agency: "Agence",
      airport: "Aéroport Tunis-Carthage",
      enfidha_hammamet: "Aéroport Enfidha-Hammamet",
      monastir: "Aéroport de Monastir Habib Bourguiba",
      djerba_zarzis: "Aéroport de Djerba-Zarzis",
      sfax_thyna: "Aéroport de Sfax-Thyna",
      tozeur_nefta: "Aéroport de Tozeur-Nefta",
      tabarka_ain_draham: "Aéroport de Tabarka-Aïn Draham",
      gafsa_ksar: "Aéroport de Gafsa-Ksar",
    } as Record<string, string>,
    locationsLabel: "Lieux",
    errSelectDates: "Choisissez les dates de prise en charge et de retour.",
    ...
    seeAllFleet: "Voir toute la flotte",
    emptyTitle: "Aucun véhicule pour ces dates",
    emptyDesc:
      "Aucun véhicule n'est disponible pour la période choisie. Essayez d'autres dates ou parcourez toute la flotte.",
  },
  cars: {
