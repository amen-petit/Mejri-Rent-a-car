...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col lg:flex-row">
      <header className="lg:hidden sticky top-0 z-50 bg-[#000000] text-white shadow-soft-lg border-b border-[#fee076]/20">
        <div className="flex items-center justify-between px-4 py-4">
          <div>
            <div className="text-lg font-bold">bahri rent a car</div>
        ...
        {menuOpen && (
          <div className="border-t border-[#fee076]/20 px-4 py-4 space-y-2">
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-semibold transition-all ${
                    isActive
                      ? "bg-[#fee076] text-[#497198] shadow-soft"
      ...
      <aside
        data-reveal="left"
        className="hidden lg:flex lg:flex-col w-72 text-white border-r border-[#fee076]/20 fixed top-0 left-0 h-full z-40 shadow-soft-lg"
        style={{
          background: "linear-gradient(180deg, #497198 0%, #497198 100%)",
        }}
      >
        <div className="p-7 border-b border-[#fee076]/20">
          <div className="text-2xl font-bold">bahri rent a car</div>
        ...
        <div className="p-4 border-t border-[#fee076]/20 space-y-3">
          <button
