...
const statusColor: Record<string, string> = {
  ...
  confirmed: "bg-[#D4AF37]/20 text-[#231F20] border-[#D4AF37]",
    ...
    if (reservation) {
      void fetch("/api/reservations/notify", {
        ...
        body: JSON.stringify({
          ...
          carBrand: reservation.car?.brand || "Yahyaoui Rent a Car",
                ...
                <div className="card-surface rounded-3xl p-5 sm:p-6 lg:sticky lg:top-6 shadow-soft-xl overflow-x-hidden">
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    <a
                      ...
                      className="w-full border-2 border-[#D4AF37] text-[#231F20] hover:bg-[#D4AF37]/10 py-2.5 rounded-xl text-sm text-center font-medium transition-colors flex items-center justify-center gap-2"
                    >
                      <svg
                        width="14"
                        height="14"
