...
const statusColor: Record<string, string> = {
  ...
  confirmed: "bg-[#dfc830]/20 text-[#18559d] border-[#dfc830]",
    ...
    if (reservation) {
      void fetch("/api/reservations/notify", {
        ...
        body: JSON.stringify({
          ...
          carBrand: reservation.car?.brand || "Royal Car",
              ...
              return (
                <div
                  ...
                  className={`card-surface relative z-10 rounded-3xl p-5 cursor-pointer transition-all bg-white ${
                    selected?.id === r.id
                      ? "border-2 border-[#dfc830] bg-[#dfc830]/10! shadow-soft-lg ring-2 ring-[#dfc830] scale-[1.01]"
                      : "border-2 border-slate-200 hover:border-[#dfc830] hover:shadow-soft"
                  }`}
                >
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-start gap-4 sm:items-center">
                      {/* Car image */}
                      <div className="relative w-14 h-14 rounded-xl border-2 border-[#dfc830] overflow-hidden shrink-0 bg-[#dfc830]/10">
                        {car?.images?.[0] ? (
                          <Image
                            src={car.images[0]}
                            alt={car.name}
                    ...
                    <div className="flex items-center justify-between gap-3 shrink-0 sm:justify-end">
                      <div className="text-left sm:text-right">
                        <div className="font-bold text-sm text-[#dfc830]">
                          {r.total_price} DT
                        </div>
            ...
            <>
              ...
              >
                <div className="card-surface rounded-3xl p-5 sm:p-6 lg:sticky lg:top-6 shadow-soft-xl overflow-x-hidden">
                  ...
                  {/* Car */}
                  <div className="bg-[#dfc830]/10 rounded-2xl p-4 mb-6 flex items-center gap-3 border-2 border-[#dfc830]">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#dfc830] font-bold mt-0.5">
                  ...
                  {/* Notes */}
                  {selected.notes && (
                    <div className="bg-slate-100 rounded-xl p-3 mb-6 text-xs text-slate-700 font-medium leading-relaxed border-l-4 border-[#dfc830]">
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    <a
                      ...
                      className="w-full border-2 border-[#dfc830] text-[#18559d] hover:bg-[#dfc830]/10 py-2.5 rounded-xl text-sm text-center font-medium transition-colors flex items-center justify-center gap-2"
                    >
                      <svg
                        width="14"
                        height="14"
