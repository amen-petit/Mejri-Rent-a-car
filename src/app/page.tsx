...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-slate-50 text-slate-900">
      ...
      >
        <div className="absolute right-0 top-0 h-96 w-96 rounded-full bg-[#89a9f1]/20 blur-3xl" />
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12">
          <div data-reveal="left" className="relative z-10 reveal-d1">
            <span className="section-label text-[#a66694]">
            ...
            <h1 className="mt-6 max-w-3xl text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
              ...
              <span className="text-[#89a9f1]">Fekra rent a car</span>{" "}
              s&apos;occupe du reste.
            </h1>
          ...
          >
            <div className="pointer-events-none absolute -right-16 -top-16 h-52 w-52 rounded-full bg-[#a66694]/20 blur-3xl" />
            <div className="relative space-y-6">
              <div className="space-y-4 rounded-3xl border border-white/20 bg-white/10 p-5 backdrop-blur-sm sm:p-6">
                <p className="text-xs uppercase tracking-widest text-[#89a9f1] font-semibold">
                  Service premium
                </p>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  >
                    <p className="text-xs uppercase tracking-widest text-[#a66694] font-semibold">
                      {label}
                    </p>
      ...
      >
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
          {stats.map((item) => (
            ...
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#89a9f1]/10 shrink-0">
                <Image
                  src={item.icon}
                  alt={item.label}
                  width={32}
            ...
            {displayedCars.length === 0 ? (
              ...
              displayedCars.map((car) => (
                ...
                >
                  ...
                  <div className="p-7">
                    <div className="text-xs uppercase tracking-widest text-[#a66694] font-bold mb-2">
                      {car.category}
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-6 text-xs text-slate-600">
                      {[
                        ...
                        <span
                          key={spec}
                          className="rounded-full bg-[#89a9f1]/10 px-3 py-1.5 font-medium"
                        >
                          {spec}
                        </span>
                      ))}
      ...
      >
        <div className="absolute -left-20 top-12 h-48 w-48 rounded-full bg-[#a66694]/10 blur-3xl" />
        <div className="max-w-7xl mx-auto">
      ...
      >
        <div className="absolute right-0 top-8 h-48 w-48 rounded-full bg-[#89a9f1]/15 blur-3xl" />
        <div
          className="relative mx-auto max-w-6xl rounded-3xl border border-[#89a9f1]/30 p-6 shadow-soft-lg sm:p-10 lg:p-16"
          style={{
            background: "linear-gradient(135deg, #1F2430 0%, #1F2430 100%)",
          }}
        >
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              <span className="inline-block text-xs uppercase tracking-widest font-bold text-[#a66694] mb-4">
