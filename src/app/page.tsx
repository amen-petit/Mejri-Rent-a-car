...
export const metadata: Metadata = {
  title: "Accueil",
  description:
    "Yahyaoui Rent a Car: location de voitures en Tunisie avec réservation en ligne simple, flotte moderne et assistance 24/7.",
  alternates: {
    canonical: "/",
  },
};
...
export default async function Home() {
  ...
  const localBusinessSchema = {
    ...
    "@type": "CarRental",
    name: "Yahyaoui Rent a Car",
    url: siteUrl,
    image: `${siteUrl}/Untitled%20design.png`,
    telephone: "24 786 189",
    address: {
      "@type": "PostalAddress",
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12">
          <div data-reveal="left" className="relative z-10 reveal-d1">
            ...
            <h1 className="mt-6 max-w-3xl text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
              ...
              <span className="text-[#D4AF37]">Yahyaoui Rent a Car</span> s&apos;occupe du
              reste.
            </h1>
