      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3 sm:px-6 sm:py-4">
        <Link href="/" className="group flex items-center">
          <div className="flex flex-col leading-none">
            <span className="text-sm font-semibold uppercase tracking-[0.2em] text-[#89a9f1]">
              Fekra rent a car
            </span>
            <span className="mt-1 text-lg font-bold text-[#1f2430] sm:text-xl">
              rent a car
            </span>
          </div>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-12 text-sm font-medium text-slate-600">
          <Link
            href="/"
            className="relative transition-colors duration-250 hover:text-navy-500 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-[#89a9f1] after:transition-all after:duration-250 hover:after:w-full"
          >
            Accueil
          </Link>
          <Link
