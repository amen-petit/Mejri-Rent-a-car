...
const variantClasses: Record<NonNullable<ButtonProps["variant"]>, string> = {
  primary:
    "text-white shadow-soft hover:-translate-y-0.5 active:translate-y-0 focus-visible:ring-2 focus-visible:ring-blue-500",
  secondary:
...
export default function Button({
  ...
  const style =
    variant === "primary"
      ? { background: "linear-gradient(135deg, #000000 0%, #a46693 100%)" }
      : {};
